...
| Date | Décision | Sujet |
|---|---|---|
| 2026-09-14 | [Sources audio : fallback par segment et notifications système](2026-09-14-sources-audio-fallback-par-segment.md) | bascule sur le micro intégré à la déconnexion, segments WAV fusionnés à l'arrêt (D1–D7) |

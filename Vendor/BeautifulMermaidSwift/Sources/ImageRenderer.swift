...
public final class MermaidImageRenderer {
    ...
    private func _renderPrepared(_ prepared: PreparedDiagram, scale: CGFloat) -> BMImage? {
        ...
        // DiagramRenderer utilise un repère haut-gauche. Un CGContext bitmap
        // AppKit utilise un repère bas-gauche : sans ce retournement, le PNG
        // et le NSImage sont entièrement inversés (texte compris).
